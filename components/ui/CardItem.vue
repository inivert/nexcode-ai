<template>
  <component
    :is="as"
    ref="refElement"
    :class="cn('w-fit select-none transition-all duration-700 ease-out will-change-transform text-white/90', $props.class)"
  >
    <slot />
  </component>
</template>
